...
router.post("/"                 ,departmentcontroller.upload_files , departmentcontroller.create_new_department);

//get specific department data
router.get("/:department_id"    , departmentcontroller.get_department);

//edit the department
router.put("/:department_id"    ,departmentcontroller.upload_files , departmentcontroller.update_department);
