...
//change passowrd
router.put("/changepassword",userware.isLoggedIn,usercontroller.change_old_password);
router.put("/:UserId/password",userware.isLoggedIn,usercontroller.change_old_password);
